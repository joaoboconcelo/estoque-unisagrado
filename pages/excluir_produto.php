...
<head>
    ...
    <script>
        function redirecionar() {
            ...
            if (idProduto) {
                window.location.href = "../php/processa_dados_exclusao.php?id_produto=" + idProduto;
            }
        }
    </script>
</head>
...
<?php
    ...
    <div class="main-content">
        <div class="delete-products">
            ...
            <form action="../php/excluir_produto.php" method="post">
                ...
                <div class="form-group"><br>
                    ...
                    <input type="text" id="nome" name="nome" disabled value="<?= htmlspecialchars($nome) ?>">
                </div>
                <div class="form-group">
                    <img src="https://img.icons8.com/material-outlined/24/000000/stack.png" alt="Ícone Quantidade" width="20">
                    <label for="quantidade">Quantidade</label>
                    <input type="number" id="quantidade" name="quantidade" disabled value="<?= htmlspecialchars($quantidade) ?>">
                </div>
                <div class="form-group">
                    <img src="https://img.icons8.com/ios-glyphs/30/000000/cheap-2.png" alt="Ícone Preço" width="20">
                    <label for="preco">Preço</label>
                    <input type="text" id="preco" name="preco" disabled value="<?= htmlspecialchars($preco) ?>">
                </div>
                <div class="form-group">
                    <img src="https://img.icons8.com/ios-glyphs/30/000000/image.png" alt="Ícone Imagem" width="20">
                    <label for="imagem">Imagem</label>
                    <input type="text" id="imagem" name="imagem" disabled value="<?= htmlspecialchars($imagem) ?>">
                </div>
                <button type="submit" class="button-submit">Excluir</button>
            </form>
            <br>
